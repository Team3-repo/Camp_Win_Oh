      ...
      <div className={styles.container}>
        ...
        <section className="basic-details">
          ...
          <FormField
            ...
            width="100%"
          />
          {errors.name && <p style={{ color: 'red' }}>{errors.name}</p>} {/* 顯示姓名錯誤訊息 */}
          ...
          <FormField
            ...
            width="100%"
          />
          {errors.email && <p style={{ color: 'red' }}>{errors.email}</p>} {/* 顯示 Email 錯誤訊息 */}
          ...
          <FormField
            ...
            width="100%"
          />
          {errors.address && <p style={{ color: 'red' }}>{errors.address}</p>} {/* 顯示地址錯誤訊息 */}
        </section>
